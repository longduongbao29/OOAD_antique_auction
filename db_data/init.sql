...
-- INSERT INTO users (name, email, password, role) VALUES ('Long Duong 2','12345','$2a$08$eDO6YfBEcPz32vAGtiiF6O640ag.d6sATOLbxUYgyFsBzdcr7DQOW','user');
...
CREATE TABLE IF NOT EXISTS place_bid_history (
    id INT AUTO_INCREMENT PRIMARY KEY,
